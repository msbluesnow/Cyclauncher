...
1. **App Version**: Always specify the exact version name or build code of the application you are running (e.g. `v0.12.0-alpha` or `19`). You can find this in the Settings screen or build config.
